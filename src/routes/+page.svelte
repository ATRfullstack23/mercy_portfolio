...
<style>
  ...
  .codes-section{display:flex;flex-direction:column;gap:2rem}.codes-copy{display:grid;gap:1rem;max-width:40rem;text-align:left}.codes-copy h2{font-size:clamp(2rem,4vw,3.5rem);line-height:0.9;letter-spacing:-.04em;text-transform:uppercase;font-weight:900}.shop-stack{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:0;width:100%;border:2px solid #000;border-right:none;border-bottom:none}.shop-card{display:grid;grid-template-rows:auto auto 1fr;gap:.95rem;padding:1.1rem;border-right:2px solid #000;border-bottom:2px solid #000;border-radius:0;background:#fff}
  ...
  .contain-preview-shop-card .shop-preview{display:grid;place-items:center;background:#000;padding:1.4rem}.contain-preview-shop-card .shop-preview img{object-fit:contain;max-width:min(100%,9rem)}
  .shop-emblem{display:grid;place-items:center;width:3.5rem;height:3.5rem;margin:.05rem auto .1rem;border-radius:0;border:1px solid #000;background:#000;}
  .shop-emblem-logo{padding:.65rem;background:#fff}.shop-emblem-logo img{width:100%;height:100%;object-fit:contain}
  .shop-card-meta{display:flex;justify-content:space-between;align-items:center;gap:.55rem;border-bottom:1px solid #000;padding-bottom:.35rem}.shop-kicker{color:#000;font-size:.54rem;font-weight:900;letter-spacing:.18em;text-transform:uppercase}.shop-badge{padding:.24rem .48rem;border:1px solid #000;border-radius:0;background:#000;color:#fff;font-size:.44rem;font-weight:900;letter-spacing:.16em;text-transform:uppercase}
  .shop-card h3{font-size:1.15rem;font-weight:900;line-height:1.05;letter-spacing:-.04em;text-transform:uppercase;color:#000}.shop-card p{font-size:.72rem;line-height:1.45}
  .shop-cta{display:inline-flex;justify-content:center;align-items:center;width:100%;margin-top:auto;padding:.82rem;border:1px solid #000;border-radius:0;background:#000;color:#fff;font-size:.58rem;font-weight:900;letter-spacing:.18em;text-transform:uppercase;text-decoration:none}
