  ...
  <footer class="footer-band" id="contact">
    <div class="footer-shell">
      <div class="footer-brand">
        ...
        <p class="footer-copy">Wellness. Beauty. Conscious living.</p>
      </div>
...
<style>
  ...
  .footer-band{display:grid;gap:1.2rem;margin-top:1.4rem;padding:clamp(1rem,3vw,1.5rem);border:1px solid var(--ink-edge);border-radius:1rem;background:linear-gradient(180deg,rgba(7,7,7,.99),rgba(4,4,4,.99));color:#f1ece6;box-shadow:0 26px 70px rgba(0,0,0,.26)}
  .footer-shell{display:grid;grid-template-columns:minmax(0,1.3fr) repeat(2,minmax(140px,.7fr));gap:1.5rem;align-items:start}
